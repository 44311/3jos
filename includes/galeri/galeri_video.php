...
<body>
    ...
    <?php
        ...
        $bannerTitle = 'Galeri Video SMPN 3 Pasar Kemis';   
    ...
    <?php
        $galeri_items = [
            ["img" => "assets/img/ini.jpg", "caption" => "Video 1"],
            ["img" => "img/ini.jpg", "caption" => "Video 2"],
            ["img" => "img/ini.jpg", "caption" => "Video 3"],
            ["img" => "img/ini.jpg", "caption" => "Video 4"],
            ["img" => "img/ini.jpg", "caption" => "Video 5"],
            ["img" => "img/ini.jpg", "caption" => "Video 6"],
            // dst
        ];

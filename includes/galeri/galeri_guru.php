...
<body>
    ...
    <?php
        $galeri_items = [
            ["img" => "img/ini.jpg", "caption" => "Galeri Guru 1"],
            ["img" => "img/ini.jpg", "caption" => "Galeri Guru 2"],
            ["img" => "img/ini.jpg", "caption" => "Galeri Guru 3"],
            ["img" => "img/ini.jpg", "caption" => "Galeri Guru 4"],
            ["img" => "img/ini.jpg", "caption" => "Galeri Guru 5"],
            ["img" => "img/ini.jpg", "caption" => "Galeri Guru 6"],
            // dst
        ];

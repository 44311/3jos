...
if (isset($_POST['tambah'])) {
    ...
    move_uploaded_file($tmp, "../../../uploads/kumpulan_dokumen/" . $file);
...
if (isset($_GET['hapus'])) {
    ...
    $result = $conn->query("SELECT file_pdf FROM kumpulan_dokumen WHERE id=$id");
    $data = $result->fetch_assoc();

    if ($data) {
        $filePath = "../../../uploads/kumpulan_dokumen/" . $data['file_pdf'];
...
<body class="container py-4">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
            <h2 class="text-center fw-bold mb-4">Layanan Kumpulan Dokumen</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/Project_SMPN3/uploads/kumpulan_dokumen/<?= $row['file_pdf'] ?>" target="_blank" class="btn btn-outline-primary btn-sm">Lihat</a>
                            </td>

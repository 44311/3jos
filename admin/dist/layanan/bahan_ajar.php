...
if (isset($_POST['tambah'])) {
    ...
    move_uploaded_file($tmp, "../../../uploads/bahan_ajar/" . $file);
...
if (isset($_GET['hapus'])) {
    ...
    $result = $conn->query("SELECT file_pdf FROM bahan_ajar WHERE id=$id");
    $data = $result->fetch_assoc();

    if ($data) {
        $filePath = "../../../uploads/bahan_ajar/" . $data['file_pdf'];
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/Project_SMPN3/uploads/bahan_ajar/<?= $row['file_pdf'] ?>" target="_blank" class="btn btn-outline-primary btn-sm">Lihat</a>
                            </td>

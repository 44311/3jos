...
$galeri = mysqli_query($conn, "SELECT * FROM galeri_prestasi ORDER BY id DESC");
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $result = mysqli_query($conn, "SELECT * FROM galeri_prestasi WHERE id = $id");
...
if (isset($_POST['submit'])) {
    ...
    if ($id_edit == '') {
        // Tambah baru
        mysqli_query($conn, "INSERT INTO galeri_prestasi (filename, caption) VALUES ('$filename', '$caption')");
    } else {
        // Edit
        mysqli_query($conn, "UPDATE galeri_prestasi SET filename='$filename', caption='$caption' WHERE id=$id_edit");
    }
...
if (isset($_GET['delete'])) {
    ...
    // Ambil nama file
    $result = mysqli_query($conn, "SELECT filename FROM galeri_prestasi WHERE id=$id");
    ...
    if ($data) {
        ...
        mysqli_query($conn, "DELETE FROM galeri_prestasi WHERE id=$id");
    }
...
<div class="container my-4">
    <h2 class="text-center fw-bold mb-4">Kelola Konten Prestasi</h2>
    ...
    <div class="form-section">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <?php if ($editMode): ?>
                    <a href="galeri_prestasi.php" class="btn btn-secondary">Batal</a>
                <?php endif; ?>
            </div>
        </form>
    </div>

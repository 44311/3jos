...
$galeri = mysqli_query($conn, "SELECT * FROM galeri_siswa ORDER BY id DESC");
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $result = mysqli_query($conn, "SELECT * FROM galeri_siswa WHERE id = $id");
...
if (isset($_POST['submit'])) {
    ...
    if ($id_edit == '') {
        // Tambah baru
        mysqli_query($conn, "INSERT INTO galeri_siswa (filename, caption) VALUES ('$filename', '$caption')");
    } else {
        // Edit
        mysqli_query($conn, "UPDATE galeri_siswa SET filename='$filename', caption='$caption' WHERE id=$id_edit");
    }
    header("Location: galeri_siswa.php");
    exit;
}
...
if (isset($_GET['delete'])) {
    ...
    // Ambil nama file
    $result = mysqli_query($conn, "SELECT filename FROM galeri_siswa WHERE id=$id");
    ...
    if ($data) {
        ...
        mysqli_query($conn, "DELETE FROM galeri_siswa WHERE id=$id");
    }
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Galeri Siswa</title>
...
<div class="container my-4">
    <h2 class="text-center fw-bold mb-4">Kelola Galeri Siswa</h2>
    ...
    <div class="form-section">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <?php if ($editMode): ?>
                    <a href="galeri_siswa.php" class="btn btn-secondary">Batal</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
